...
const ACCOUNTS = [
  { username: "superadmin",    email: "superadmin@versoair.test",    role: "superuser",         display_name: "Super Admin",      avatar_url: "https://i.pravatar.cc/150?u=superadmin" },
  { username: "artist_demo",   email: "artist_demo@versoair.test",   role: "artist",            display_name: "Artist Demo",      avatar_url: "https://i.pravatar.cc/150?u=artist_demo" },
  { username: "community_demo",email: "community_demo@versoair.test",role: "community_manager", display_name: "Community Demo",   avatar_url: "https://i.pravatar.cc/150?u=community_demo" },
  { username: "listener_demo", email: "listener_demo@versoair.test", role: "user",              display_name: "Listener Demo",    avatar_url: "https://i.pravatar.cc/150?u=listener_demo" },
];
...
async function run() {
  ...
  try {
    ...
    const [sa, ar, cm, li] = ["superadmin","artist_demo","community_demo","listener_demo"].map(k => userIds[k]);

    // 2. Cross-follows ─────────────────────────────────────────────────────
    const followPairs = [[ar, li],[li, ar],[ar, cm],[cm, ar],[li, cm],[sa, ar]];
    ...
    const posts = [
      { uid: cm, content: "[CDP] Welcome to the community hub — let's connect!" },
      { uid: cm, content: "[CDP] Business tip: consistency beats perfection every time." },
      { uid: ar, content: "[MUDP] Just dropped a new Afrobeats track — feedback welcome!" },
      { uid: ar, content: "[CrossDP] Collab between artists and community managers incoming 🔥" },
      { uid: li, content: "[CDP] This platform is amazing, found 3 new artists today." },
    ];
    ...
    const convoPairs = [[ar, li, "dm_share"],[ar, cm, "dm_share"],[li, cm, "dm_share"]];
