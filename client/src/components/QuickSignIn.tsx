    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          {/* Modal */}
          <div className="fixed inset-0 z-[101] overflow-y-auto overscroll-contain touch-pan-y flex items-start justify-center p-3 sm:p-4 pointer-events-none [-webkit-overflow-scrolling:touch]">
            <motion.div
            ...
            >
              <div className="bg-[#0f0a1a] border border-purple-500/30 rounded-2xl shadow-2xl shadow-purple-500/20 overflow-hidden max-h-[calc(100dvh-1.5rem)] flex flex-col">
                {/* Header */}
