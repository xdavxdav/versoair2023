...
import { SmartNavDock } from "@/components/SmartNavDock";
import {
  Home,
  BookOpen,
  ShoppingBag,
...
export default function ContentNav() {
  ...
  return (
    <>
      ...
      {/* ══ MOBILE NAV DOCK ════════════════════════════════════════════ */}
      <div
        className="md:hidden fixed left-0 right-0 z-50 bottom-0 pointer-events-none transition-all duration-300"
        style={{ paddingBottom: "env(safe-area-inset-bottom, 0px)" }}
      >
        <SmartNavDock
