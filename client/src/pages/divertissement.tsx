...
export default function Entertainment() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-900 via-pink-900/20 to-gray-900 text-white">
      {/* Quick Navigation */}
      <div className="sticky top-0 z-40 bg-gray-900/90 backdrop-blur-md border-b border-pink-500/20">
      ...
      <div className="fixed top-20 right-4 z-50">
        <motion.div
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-md border shadow-lg bg-pink-900/30 text-pink-300 border-pink-500/30"
        >
          <Database className="h-4 w-4" />
          <span className="text-sm font-medium">
            Entertainment PostgreSQL Database
          </span>
              ...
              <div className="flex items-center gap-4">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="outline"
                      className="w-[180px] bg-slate-700 border-purple-600 justify-between"
                    >
