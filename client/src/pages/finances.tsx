    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-900 via-emerald-900/20 to-gray-900 text-white">
      ...
      <div className="fixed top-20 right-4 z-50">
        <motion.div
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-md border shadow-lg bg-emerald-900/30 text-emerald-300 border-emerald-500/30"
        >
          <Database className="h-4 w-4" />
          <span className="text-sm font-medium">
            Financial PostgreSQL Database
          </span>
