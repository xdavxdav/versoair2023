                              ...
                              <div className="p-[clamp(0.75rem,2vw,2.5rem)]">
                                <div className="flex items-start justify-between mb-4">
                                  <div className="flex-1">
                                    <h4 className="text-sm sm:text-base md:text-lg font-bold text-white group-hover:text-emerald-300 transition-colors mb-2 line-clamp-1">
                                      {business.title}
                                    </h4>
                                    <div className="flex items-center gap-[0.5vw] text-gray-400">
                                      <Building className="h-[clamp(1rem,1.2vw,1.25rem)] w-[clamp(1rem,1.2vw,1.25rem)] text-emerald-500" />
                                  ...
                                  <div className="flex flex-col items-end gap-1">
                                    <div className="flex items-center gap-[0.5vw] bg-gradient-to-br from-emerald-400 to-green-500 px-3 py-2 rounded-xl shadow-xl">
                                ...
                                <div className="space-y-[0.75vw] mb-4">
                                  <div className="flex items-center justify-between text-sm">
                                    <div className="flex items-center gap-[0.5vw]">
                                      <Users className="h-[clamp(1rem,1.2vw,1.25rem)] w-[clamp(1rem,1.2vw,1.25rem)] text-emerald-400" />
                                    ...
                                    <div className="flex items-center gap-[0.5vw]">
                                      <CreditCard className="h-[clamp(1rem,1.2vw,1.25rem)] w-[clamp(1rem,1.2vw,1.25rem)] text-green-400" />
                                      <span className="text-gray-300">
                                        Financial
                                      </span>
                                    </div>
