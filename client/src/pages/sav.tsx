...
export default function SAV() {
  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        "Connectivity issues (Bluetooth, WiFi, USB)",
    ...
    {
      id: "physical",
      name: "Physical Product Services",
      icon: <Package className="h-6 w-6" />,
      color: "from-green-500 to-green-600",
      services: [
        "Product replacement for manufacturing defects",
        "Warranty claims processing",
        "Size exchange and fit adjustments",
        "Material quality issues resolution",
        "Component replacement (laces, soles, accessories)",
    ...
    },
    {
      ...
      services: [
        "Music streaming account recovery",
        "Digital content access issues",
        "Subscription management and billing",
        "Content synchronization across devices",
        "Playlist restoration and backup",
        "Audio quality troubleshooting",
        "Download and offline access problems",
    ...
    },
    {
      ...
      services: [
        ...
        "Payment gateway problems resolution",
  ...
  const commonIssues = [
    {
      issue: "Login & Account Access",
      percentage: "32%",
      color: "bg-blue-500",
      width: "32%",
      resolution: "15min avg",
      trend: "down",
    },
    {
      ...
      <div className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 py-20 overflow-hidden">
        ...
        <div className="relative max-w-[95vw] mx-auto px-6">
          <div className="text-center">
            ...
            >
              <Link href="/tickets">
                <Button className="bg-white text-blue-600 px-8 py-6 text-lg hover:shadow-xl transform hover:-translate-y-1 transition-all">
      ...
      <div className="max-w-[95vw] mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          <div className="relative">
            ...
            <Input
              placeholder="Search for solutions, guides, or contact support..."
              className="pl-12 py-6 text-lg rounded-full border-gray-300 shadow-sm"
              value={searchQuery}
          ...
          <div className="space-y-12">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto mb-8">
                Select a category to view specific support services and
                resolution details
              </p>
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-full font-semibold transition-all duration-200 flex items-center gap-2 ${
                    activeCategory === "all"
                      ...
                      : "bg-white text-gray-700 shadow-md hover:shadow-lg border"
                  }`}
                >
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {(activeCategory === "all"
                ...
                <div
                  key={category.id}
                  className={`bg-gradient-to-br ${category.color} rounded-2xl p-8 text-white hover:shadow-2xl transition-all duration-300`}
                >
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-4">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {performanceMetrics.map((metric, index) => (
                  <div key={index} className="bg-gray-50 rounded-xl p-6">
                    ...
                    <ProgressBar percent={90} className="h-2" />
                  </div>
                ))}
              </div>
            </div>
                  ...
                  <form className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                        <DownloadCloud className="h-8 w-8 text-gray-400 mx-auto mb-2" />
              ...
              <form className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-500 transition-colors cursor-pointer">
                    <DownloadCloud className="h-10 w-10 text-gray-400 mx-auto mb-4" />
                    <p className="text-gray-700 font-medium">
                      Drag & drop files or click to browse
                    </p>
                    <p className="text-sm text-gray-500 mt-2">
                      Support files, screenshots, or documents (Max 20MB)
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
