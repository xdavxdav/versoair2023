          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="grid grid-cols-3 gap-3 mb-4">
                ...
                <button
                  type="button"
                  className="flex flex-col items-center gap-1.5 px-3 py-3 bg-white hover:bg-gray-50 border border-gray-200 rounded-xl text-gray-700 transition-all text-xs font-medium shadow-sm hover:shadow-md"
                >
                ...
                <button
                  type="button"
                  className="flex flex-col items-center gap-1.5 px-3 py-3 bg-gray-900 hover:bg-gray-800 border border-gray-900 rounded-xl text-white transition-all text-xs font-medium shadow-sm hover:shadow-md"
                >
                  <svg
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
